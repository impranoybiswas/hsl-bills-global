...
export default function Navbar() {
  ...
  return (
    <nav className="fixed h-14 w-full border-b border-green-500/50 shadow flex items-center justify-between px-4 md:px-8 lg:px-12">
      <Image
        className="h-8 w-fit"
        src="/title.png"
        alt="HSL Title"
      ...
      {status === "authenticated" && (
        <div className="flex items-center gap-2">
          ...
          <div className="relative">
            ...
            <div
              className={`absolute top-10 right-0 rounded-b-md shadow bg-green-100 min-h-32 cursor-pointer transition-all duration-300 ease-in-out p-3 flex flex-col gap-3 z-100  ${
